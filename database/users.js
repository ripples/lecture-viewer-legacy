...
exports.addCourseById = function(id, courseId, callback) {
    User.findById(id, function(err, user) {
        if (err) callback(err);
        else if (!user) callback("email does not exist");
        else {
            console.log(user);
...
exports.getUserByEmail = function(email, callback) {
    User.findOne({
        ...
        if (err) callback(err);
        else if (!user) callback("user does not exist");
 ...
 */
exports.setVerification = function(user_id, verification, callback) {
...
/*
 * Method that resets the password of a given user.
 */
exports.resetPassword = function(user_id, newPassword, callback) {
